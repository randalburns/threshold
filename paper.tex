...
Furthermore, caching the results of threshold queries preserves both the I/O and computation effort used to obtain them, which allows subsequent
queries for some of the most interesting regions and features of the dataset to run orders of magnitude faster.
\end{abstract}

%% % A category with the (minimum) three required fields
\category{H.2.8}{Database Management}{Database Applications -- scientific, spatial databases and GIS}
...
the entire time-step or a significant fraction of it for queries with thresholds that are set too low. Currently this limit is around $10^6$ locations, which is
sufficient to examine a time-step in detail. In the case of the vorticity these locations contain all values within $\sim$8 times the root mean squared value of
the vorticity, which is about $25\%$ of the maximum. Given that we are interested in extreme events, obtaining the locations with values even within $50\%$ 
of the maximum would be sufficient. 
...
\begin{figure*}
\centering
\subfigure[Scale-up with multiple processes per node]{\includegraphics[width=3.35in]{Figures/scaleup.pdf}\label{fig:scaleup}}
\subfigure[Scale-out to multiple nodes]{\includegraphics[width=3.35in]{Figures/scaleout.pdf}\label{fig:scaleout}}
...
\begin{figure*}
\centering
\subfigure[Vorticity]{\includegraphics[width=2.2in]{Figures/vorticity_breakdown.pdf}\label{fig:vorticity_breakdown}}
\subfigure[Q-criterion]{\includegraphics[width=2.2in]{Figures/q_breakdown.pdf}\label{fig:q_breakdown}}
\subfigure[Magnetic field]{\includegraphics[width=2.2in]{Figures/magnetic_breakdown.pdf}\label{fig:magnetic_breakdown}}
\subfigure[Vorticity (cache hit)]{\includegraphics[width=2.2in]{Figures/vorticity_breakdown_cachehit.pdf}\label{fig:vorticity_breakdown_cachehit}}
\subfigure[Q-criterion (cache hit)]{\includegraphics[width=2.2in]{Figures/q_breakdown_cachehit.pdf}\label{fig:q_breakdown_cachehit}}
\subfigure[Magnetic field (cache hit)]{\includegraphics[width=2.2in]{Figures/magnetic_breakdown_cachehit.pdf}\label{fig:magnetic_breakdown_cachehit}}
