...
{\bf Distributed data-parallel execution}. In most cases threshold queries operate over an entire time-step. Therefore, each such query is subdivided by 
...
avoid dirty-reads or inconstant view of the cache. Caching the query results
...
\multirow{2}{0.8in}{Points above threshold} & \multicolumn{3}{|c|}{Running time (s.)}\\ \cline{2-4}
 & No cache & \parbox[t]{0.7in}{With cache (miss)} & \parbox[t]{0.7in}{With cache (hit)} \\ \hline
4247 & 97.1 & 100.2 & 0.5\\ \hline
86580 & 113.7 & 115.9 & 1.2\\ \hline
909274 & 111.6 & 115.0 & 9.1\\ \hline
\end{tabular}
