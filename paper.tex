...
In the case of computational turbulence this allows scientists to quickly focus on the most intense regions in any time-step or the dataset as a whole,
which greatly speeds up the rate of scientific exploration and discovery. 
...
Server) as opposed to designing a new database system from the ground up as Andrade et al. \cite{Andrade}.
