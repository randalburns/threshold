...
We extend the database system with the introduction of an application-aware cache for query results, building on the concept of semantic caching.
...
Even approaches that aim to work with general score functions \cite{TODO} assume that the function operates on the attributes of a single record.
...
Johns Hopkins Turbulence Databases (JHTDB). The JHTDB, built on top of the GrayWulf and Data-Scope clusters, serve as a public virtual laboratory for
