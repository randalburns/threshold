...
the boundary of each region will be requested by multiple threads. Nevertheless, running with 4 threads per node is nearly 2.5 times faster when compared to
